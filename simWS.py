...
configuration = { 
    'local': {
            'scratchDir':'/tmp',
            'serviceDir':'/usr/local/packages/Simulator-WS-v3.1.0',
            'templateDir':'/usr/local/packages/Simulator-WS-v3.1.0/templates',
            'logFile':'/usr/local/packages/Simulator-WS-v3.1.0/sim.log',
            'wsdlFile':'/usr/local/packages/Simulator-WS-v3.1.0/simulator_service_3.1.0.wsdl',
            'apolloPyDir':'/usr/local/packages/apollo-db-python-module',
            'port':'8094',
            'version':'3.1.0',
            'apolloDBName':'apollo_310_snapshot',
            'apolloDBHost':'',
            'apolloDBUser':'',
            'apolloDBPword':''
    },
    ...
    'machines':{
        'pscss.olympus.psc.edu':{
                ...
                'queueType':'PBS',
                'priorityQueue':'batch',
                'remoteDir':'/mnt/beegfs0/users/ows_simulator/apolloTemp',
                ...
                'apolloPyLoc':'',
                'apolloPyModule':'module load apollo/apollo-3.0.2',
                'qstatCommand':'qstat',
                'useModules':True,
    ...
    'simulators':{
        'mappings':{
            ...
            'Swiss TPH_OpenMalaria_1.0_':'openmalaria_32',
	    'Swiss TPH_OpenMalaria_R0063_':'openmalaria_32',
	    'Swiss TPH_OpenMalaria_R0065_':'openmalaria_32',
	    'Swiss TPH_OpenMalaria_R0068_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0111_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0115_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0121_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0131_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0132_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0133_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0670_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0674_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_R0678_':'openmalaria_32',
            'Swiss TPH_OpenMalaria_base_':'openmalaria_32',
            'test':'test',
            'fred':'fred_V1'
        },
    	'fred_V1':{
        ...
        'fred_V1_i':{
            ...
            'runDirPrefix':'fred.tmp',
    	    'preProcessCommand':'',
            'moduleCommand':['module load fred/pfred-0.0.3'],
            'moduleName':['fred/pfred-0.0.3'],
    	...
    	'flute_v1.15':{
    	    ...
    	    'runCommand':'run_flute_apollo.bash',
        ...
        'openmalaria_32':{
            ...
            'runCommand':'run_om_apollo.bash',
            'dbCommand':'',
            'dbCommand':'python $APOLLO_HOME/om_to_apollo.py -o OUT -i <<ID>>',
            'statusCommand':'python $APOLLO_HOME/apollo_update_status.py -r <<ID>>',
            'big':'',
            'medium':'',
            'small':'',
