##################################################
# file: SimulatorService_v3_1_0_client.py
# 
...
# Locator
class SimulatorService_v3_1_0Locator:
    ...
    def getSimulatorServiceEndpointAddress(self):
        return SimulatorService_v3_1_0Locator.SimulatorServiceEndpoint_address
    def getSimulatorServiceEndpoint(self, url=None, **kw):
        return SimulatorServiceBindingSOAP(url or SimulatorService_v3_1_0Locator.SimulatorServiceEndpoint_address, **kw)
...
class SimulatorServiceBindingSOAP:
    ...
    def runSimulation(self, request, **kw):
        ...
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="http://service.apollo.pitt.edu/simulatorservice/v3_1_0/runSimulation", **kw)
        # no output wsaction
    ...
    def getScenarioLocationCodesSupportedBySimulator(self, request, **kw):
        if isinstance(request, getScenarioLocationCodesSupportedBySimulatorRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="http://service.apollo.pitt.edu/simulatorservice/v3_1_0/getScenarioLocationCodesSupportedBySimulator", **kw)
        # no output wsaction
    ...
    def runSimulations(self, request, **kw):
        if isinstance(request, runSimulationsRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="http://service.apollo.pitt.edu/simulatorservice/v3_1_0/runSimulations", **kw)
        # no output wsaction
    ...
    def getPopulationAndEnvironmentCensus(self, request, **kw):
        if isinstance(request, getPopulationAndEnvironmentCensusRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="http://service.apollo.pitt.edu/simulatorservice/v3_1_0/getPopulationAndEnvironmentCensus", **kw)
        # no output wsaction
    ...
    def terminateRun(self, request, **kw):
        if isinstance(request, terminateRunRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="http://service.apollo.pitt.edu/simulatorservice/v3_1_0/terminateRun", **kw)
        # no output wsaction
